...
/>
              ...
              <v-card-text class="white--text">
                From sweet to savory, we’ve got the magic to tame your cravings!
              </v-card-text>
            </v-col>
...
#cont {
  width: 100%;
  height: 100%;
  background: linear-gradient(135deg, #5f0092, #5200b6);
  display: flex;
  align-items: center;
...
.gradient-button {
  color: white;
  background: linear-gradient(135deg, #9245f7, #a600ff);
  border: none;
  font-weight: bold;
